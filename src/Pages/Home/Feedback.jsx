    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center text-center py-16 px-4 ">
        <div className="max-w-4xl mx-auto mt-10">
          <h1 className="text-teal-600 font-bold text-4xl md:text-6xl mb-4 italic ">Survey Feedback Overview</h1>
      ...
      <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="space-y-6">
                {data.map((item, index) => (
                  <div key={index} className="border-b border-gray-100 last:border-b-0 pb-4 last:pb-0">
                    ...
                    <p className="text-gray-700 leading-relaxed pl-4 border-l-2 border-gray-200">{item.transcript}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="flex justify-center ">
           <button className='px-14 cursor-pointer rounded-full py-3 mt-10 bg-gradient-to-t from-[#02362E] to-[#298F7D] text-gray-100' >View Survey Result</button>
        </div>
      </div>
    </div>
    </div>
