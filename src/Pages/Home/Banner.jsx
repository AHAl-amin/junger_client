...
>
  <div className=' relative flex flex-col items-center justify-center h-[calc(100vh-100px)]   text-white text-center'>
    ...
    <p className='text-xl font-semibold text-[#637270] md:w-1/3 text-center mt-4'>Answer a few questions to help us improve our services. Your feedback matters to us!</p>
    <div className='absolute mt-26 '>
      <div className=' flex justify-center items-center '>
        <img src={VoiceImg} alt="" className='w-80 h-80 ' />
      </div>
    </div>
