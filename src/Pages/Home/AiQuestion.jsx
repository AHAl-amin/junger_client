...
//                                         className={`relative rounded-full md:h-26 h-18 w-18 md:w-26  transition-all duration-300 transform flex items-center justify-center cursor-pointer ${isRecording
...
export default function AiQuestion() {
  ...
  const agentId = "agent_2401k1n3b0b5ed0s402cvcnvq2dn"; // from ElevenLabs dashboard
  const voiceId = "cjVigY5qzO86Huf0OWal"; // optional override
    ...
    >
      <div className="bg-[linear-gradient(to_bottom_left,#0C4B4000,#E0ECE940,#FFFFFF)] h-[calc(100vh-7.5rem)]">
        ...
        <div className="">
          ...
          <h1 className="text-teal-600 font-bold flex md:mt-20 mt-10 justify-center items-center text-2xl md:text-4xl  italic">
               Let's started your survey
              </h1>
        <div className="">
          <div className="px-4 max-w-4xl mx-auto my-auto md:mt-60 mt-40 w-full relative space-y-4">
