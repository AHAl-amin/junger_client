...
const colorPerItem = [
    { id: 0, value: 7, label: 'Response', color: '#26779A' },
    { id: 1, value: 3, label: 'No response', color: '#E57373' },
];
        ...
        <div className='bg-[#F7FEFC]'>
            ...
            <div className=' mx-auto max-w-7xl space-y-12 '>
                ...
                <div className='bg-[#FFFFFF] shadow md:p-10 p-4 md:mb-10 md:mx-0 mx-4  rounded '>
                    <p className='text-gray-600 md:text-3xl  text-xl mb-8 md:mb-0 '>Response Distribution</p>
                    ...
                    <div className='flex justify-center items-center gap-10 mt-10 mb-10'>
                        <div className='flex md:gap-4 gap-2 items-center'>
                            ...
                            <p className='md:text-3xl text-xl text-gray-500'>Response</p>
                        </div>
                        
                        <div className='flex md:gap-4 gap-2 items-center'>
                            <div className='md:w-8 md:h-8 w-4 h-4 bg-[#E57373] rounded-full'></div>
                            <p className='md:text-3xl text-xl text-gray-500'>No Response</p>
                        </div>
                    </div>
                </div>
                <div className=" md:mx-auto p-6 mb-10 bg-[#FFFFFF] rounded shadow  mx-2">
                    {/* Header */}
                    ...
                    <div className="grid grid-cols-2 gap-8 mb-4 p-4 rounded bg-[#E7EDEC]">
                        <div className="text-teal-600 font-bold text-[16px] md:text-2xl ">Questions</div>
                        <div className="text-teal-600 font-bold text-[16px] md:text-2xl">Your Response</div>
                    </div>
                    {/* Response Rows */}
                    <div className="space-y-0">
                        {responsesData?.responses?.map((item, index) => (
                            <div
                                key={item.id}
                                className={`grid grid-cols-2 md:gap-8 py-6 px-4 ${index % 2 === 0 ? "bg-gray-50" : "bg-white"}`}
                            >
                                <div className="text-gray-800 md:text-xl leading-relaxed">{item.question}</div>
                                <div className="text-gray-600 md:text-xl leading-relaxed">
                    ...
                    {/* Action Buttons */}
                    <div className="flex md:gap-12 gap-4 my-12 justify-center ">
                        <button className="flex items-center gap-2 md:px-6 py-2 px-2 md:py-3 border border-[#023129] md:font-bold font-medium text-[12px] md:text-[16px] text-[#023129] rounded-full cursor-pointer hover:bg-gray-50 transition-colors">
                            <FiDownload />
                            Export Result
                        </button>
                        <Link to='/'>
